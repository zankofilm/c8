...
function renderOffice(){
  ...
  shell(`
    <div class="dashboard-main-grid pro-main-grid">
      ...
      ${dashboardPrimaryCard("backup","backup","بکاپ و بازیابی","خروجی گرفتن و بازگردانی اطلاعات سیستم","green")}
...
// ================= INDEXEDDB OFFLINE LAYER (PRO UPGRADE) =================

const DB_NAME = "javanrood_ngo_db";
...
// enhance existing saveState (non-breaking)
...
// restore from indexedDB after load
idbLoad("state", function(data){
...
// ================= BACKUP / RESTORE SYSTEM (FULL OFFLINE) =================
...
function exportBackup(){
  ...
  const a = document.createElement("a");
  a.href = url;
  a.download = "javanrood_backup.json";
  a.click();
